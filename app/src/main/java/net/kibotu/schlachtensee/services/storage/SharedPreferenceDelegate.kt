...
private class SharedPreferenceDelegate<T>(
    ...
    private val sharedPreferences: SharedPreferences by lazy {
        PreferenceManager.getDefaultSharedPreferences(context ?: application)
    }
...
fun <T> sharedPreference(key: String, defaultValue: T): ReadWriteProperty<Any, T> =
    sharedPreference(application!!, key, defaultValue)
...
fun <T> sharedPreference(
    ...
    when (defaultValue) {
        is Parcelable -> SharedPreferenceDelegate(
            context,
            defaultValue,
            SharedPreferences::getParcelable,
...
inline fun <reified T : Parcelable> SharedPreferences.getParcelable(key: String, defValue: T): T =
    getString(key, defValue.toJson())!!.fromJson()

inline fun <reified T : Parcelable> Editor.putParcelable(key: String, value: T): Editor =
