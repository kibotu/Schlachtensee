...
public class FluidView extends View {
    ...
    private static final float CALM_SPEED = 0.1f;

    private final Interpolator mInterpolator = new DecelerateInterpolator(0.5f);

    private long mLastDrawTime;
    private Path mMaskPath;
    public float mTargetIntensity = 0f;
    public float mShakeIntensity = 0f;
    private float mFillLevel = 1f;

    public boolean enableCalming = false;
    ...
    private void init(Context context) {
        ...
        mWaves = new Wave[]{
                new Wave(getColor(context, R.color.fluidBackWaveStart), getColor(context, R.color.fluidBackWaveEnd)) {
                    @Override
                ...
                new Wave(getColor(context, R.color.fluidFrontWaveStart), getColor(context, R.color.fluidFrontWaveEnd)) {
                    @Override
                    public void update(Canvas canvas, float deltaTime, float factor) {
