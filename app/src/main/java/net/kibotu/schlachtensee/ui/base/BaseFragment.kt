...
abstract class BaseFragment : Fragment(), BackPress, DispatchTouchEventHandler,
    ...
    protected val appViewModel by inject<AppViewModel>()
        ...
        try {
            ...
            if (e.message?.contains("WebView") == true) {
                ...
                startActivity(
                    Intent(
                        Intent.ACTION_VIEW,
                        Uri.parse("http://play.google.com/store/apps/details?id=com.google.android.webview")
                    )
                )
    ...
    open fun unsubscribeUi() {
        ...
        appViewModel.onConnectionUpdate.removeObserver(onConnectionUpdate)
    }
